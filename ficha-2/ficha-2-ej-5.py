...
Desarrolle un programa que dados los valores x e y, determine el valor de los dos ángulos alfa y beta. No es necesario convertir a grados,
...
#Resultado
rta= f"El valor del ángulo alfa es: {alfa}\nEl valor del ángulo beta es: {beta}"
print("--------------------------")
